...
public:
    ...
    virtual void setDeviceType(const ILayer* layer, NVDeviceType deviceType) noexcept = 0;
    virtual NVDeviceType getDeviceType(const ILayer* layer) const noexcept = 0;
    ...
    virtual void setDLACore(int32_t dlaCore) noexcept = 0;
    virtual int32_t getDLACore() const noexcept = 0;
    virtual void setDefaultDeviceType(NVDeviceType deviceType) noexcept = 0;
    virtual NVDeviceType getDefaultDeviceType() const noexcept = 0;
