...
from core.loss import DistillationBasedLoss
from core.function import train_exit
from core.function import validate_exit
from utils.utils import get_frozen_optimizer
...
def main():
    ...
    model_pretrained = torchmodels.resnet101(pretrained=True)
    ...
    # The resnet101 backbone has 624 items (626 including the last two fc layere)
    for i in range(624):
    ...
    optimizer = get_frozen_optimizer(config, model)
