...
class PoseResNetwthExit(nn.Module):
    def __init__(self, block, layers, cfg, **kwargs):
        ...
        extra = cfg.MODEL.EXTRA
        self.deconv_with_bias = extra.DECONV_WITH_BIAS
        self.backbone_s1 = backbone_s1(start_point=14, end_point=17)
        self.backbone_s2 = backbone_s2(start_point=14, end_point=17)
...
def get_pose_net_with_exit(cfg, is_train, **kwargs):
    num_layers = cfg.MODEL.EXTRA.NUM_LAYERS
    style = cfg.MODEL.STYLE
    ...
    model = PoseResNetwthExit(block_class, layers, cfg, **kwargs)
