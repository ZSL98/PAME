...
parser.add_argument('--resume', default='./checkpoint_13.pth.tar', type=str, metavar='PATH',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = resnet_s1(start_point=14, end_point=33, simple_exit=False)
